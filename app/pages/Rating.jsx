	...
	return (
		...
		<div className="bloglist">
			<div className="container">
				...
				<p>Ключевыми критериями оценки сайтов являются: проверка на наличие обязательных разделов по требованиям предъявляемым к сайтам образовательных организаций, анализ кода главной страницы, анализ данных сервера, история доменного имени, данные сторонних сервисов и т.д.
					В следующей версии рейтинга методология оценки будет изменена, за счёт увеличения технических параметров оценки.</p>
				<p>Текущая версия: <b>Октябрь 2022</b></p>
